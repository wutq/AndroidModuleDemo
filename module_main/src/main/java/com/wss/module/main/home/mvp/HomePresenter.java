            ...
            new Thread() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        list.add(new MainBlock("玩安卓", ARouterConfig.WAN_MAIN_ACTIVITY, R.drawable.main_home_icon_1));
                        list.add(new MainBlock("商城", ARouterConfig.MARKET_MAIN_ACTIVITY, R.drawable.main_home_icon_4));
                        list.add(new MainBlock("花花", "https://www.jianshu.com/p/8703343be072", R.drawable.main_home_icon_3));
                        list.add(new MainBlock("树木", "https://www.jianshu.com/p/fadfd7965865", R.drawable.main_home_icon_2));
                        list.add(new MainBlock("草草", "https://www.jianshu.com/p/3977a1c2d07b", R.drawable.main_home_icon_6));
                        list.add(new MainBlock("猫猫", "https://www.jianshu.com/p/bce49dccc962", R.drawable.main_home_icon_5));
