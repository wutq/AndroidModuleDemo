...
public class GoodsCommentPresent extends BasePresenter<GoodsCommentModule, IGoodsCommentView> {
    ...
    @Override
    protected GoodsCommentModule createModule() {
        return new GoodsCommentModule();
    }
}
