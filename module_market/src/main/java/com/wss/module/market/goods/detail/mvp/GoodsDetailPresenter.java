...
public class GoodsDetailPresenter extends BasePresenter<GoodsDetailModule, IGoodsDetailView> {
    ...
    @Override
    protected GoodsDetailModule createModule() {
        return new GoodsDetailModule();
    }
