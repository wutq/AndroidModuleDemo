...
import com.wss.module.market.ui.main.mvp.model.MarketMainModel;
...
public class MarketMainPresenter extends BasePresenter<MarketMainModel, MarketMainContract.View>
    ...
    public void getMarketData() {
        ...
        getView().refreshGoodsList(list);
    }

    @Override
    public void getCartCount() {
        getView().refreshCartCount(ShoppingCartUtils.getCartCount());
    }

    @Override
    protected MarketMainModel createModule() {
